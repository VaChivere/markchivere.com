...
export const metadata: Metadata = {
  ...
  description: "Real-world results: 42% stress reduction, 30x revenue growth, and transformed leadership capabilities.",
};
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
                    ...
                    <p className="text-gray-600 leading-relaxed italic">
                        "The integration of AI tools into our leadership curriculum didn't just modernize the content—it engaged our leaders in a way we haven't seen in years. Mark's approach demystified the technology and focused purely on the human advantage."
                    </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
                    ...
                    <p className="text-gray-600 leading-relaxed italic">
                        "We were struggling with hybrid work friction. The data-driven insights combined with Mark's facilitation helped us reset our team norms. Productivity is up, but more importantly, stress is down."
                    </p>
                </div>
             </div>
        </div>
